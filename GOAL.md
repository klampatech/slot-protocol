...
- **`index.html` is 6529 lines as of HEAD.** Bumped from 5680 at Phase 4.5-Q → ~6250 at Phase 7 → 6331 at Phases 8a/8b → 6529 at Phase 8c (Phases 5-8c + code-review + test infra).
