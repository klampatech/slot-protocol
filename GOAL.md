...
- **Visual system** — Blade Runner 2049 direction: Orbitron + Share Tech Mono typography, neon-line-art icon set (30+ entries), refined outline + glow buttons, scanline + CRT vignette ambient. Color scheme unchanged from Phase 2c.
- All Phase 2c functionality preserved: tooltips, payloads, daily challenge, audio, etc.
